...
static Scene dayLightTest(const CApp& app) {
	...
	HittableList tempWorld = HittableList();

	cam.m_lookAt = Point3(0.0, 0.0, 0.0);
	cam.m_orig = Point3(10.0, 0.0 , 0.0);//Point3(3.8, 0.0, -4.5);
	...
	tempWorld.add(std::make_shared<Sphere>(Point3(0.0, 0.0, 0.0), 1.0, LAMB_TEMP1));
	tempWorld.add(std::make_shared<Sphere>(Point3(2.0, 2.0, 5.0), 1.0, LAMB_TEMP1));
	tempWorld.add(std::make_shared<Sphere>(Point3(3.0, -2.0, 1.0), 1.0, LAMB_TEMP1));
	tempWorld.add(std::make_shared<Sphere>(Point3(2.0, 4.0, -4.0), 1.0, LAMB_TEMP1));
	tempWorld.add(std::make_shared<Sphere>(Point3(-2.0, -4.0, 2.0), 1.0, LAMB_TEMP1));
	tempWorld.add(std::make_shared<Sphere>(Point3(4.0, 6.0, -6.0), 1.0, LAMB_TEMP1));
	tempWorld.add(std::make_shared<Sphere>(Point3(-3.0, -6.0, 2.0), 1.0, LAMB_TEMP1));
	...
	tempWorld.add(std::make_shared<Sphere>(Point3(1.5, 0.0, 0.0), 0.5, make_shared<Lambertian>(Color(1.0, 0.01, 0.01))));
	tempWorld.add(std::make_shared<Sphere>(Point3(-1.5, 0.0, 0.0), 0.5, make_shared<Lambertian>(Color(0.7, 0.7, 0.01))));
	tempWorld.add(std::make_shared<Sphere>(Point3(0.0, 0.0, 1.5), 0.5, make_shared<Lambertian>(Color(0.01, 0.01, 1.0))));
	tempWorld.add(std::make_shared<Sphere>(Point3(0.0, 0.0, -1.5), 0.5, make_shared<Lambertian>(Color(0.01, 0.7, 0.7))));
